        ...
        db.collection('posts')
            ...
            .then(docc => {
                ...
                if (show == 'like2') {
                    db.collection("posts")
                        ...
                        .then(doc2 => {
                            if (doc2.data()) {
                                ...
                                db.collection("posts").doc(postId).collection("likes").doc(user && user.uid).set({
                                    likes: 1
                                });
                    ...
                    db.collection('posts').doc(postId).collection('likes').doc(user && user.uid).delete().then(function () {
                        db.collection('posts').doc(postId).update({
                            noLikes: data.noLikes - 1
                        });
                    })
